...
//    }
    ...
    public ArrayList<PhieuNhapDTO> searchDate(Date fromDate, Date toDate) {
        ...
        // Gọi phương thức của DAO hoặc thực hiện tìm kiếm trong cơ sở dữ liệu ở đây
        // Ví dụ:
        // resultList = phieunhapDAO.searchByDate(fromDate, toDate);
...
//                    JOptionPane.showMessageDialog(this, "Khoảng tiền không hợp lệ", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
//                }
//            }
//        }
//        return result;
